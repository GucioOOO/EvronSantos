...
function showSettingsWindow()
	...
	GUIEditor_Window.main = guiCreateWindow(x,y,w,h,"Ustawienia gry",false)
	...
	GUIEditor_Tab.graphicSettings = guiCreateTab("Ustawienia Konta",GUIEditor_TabPanel.main)
	--GUIEditor_Tab.accSettings = guiCreateTab(" Ustawienia",GUIEditor_TabPanel.main)
	GUIEditor_Tab.charSettings = guiCreateTab("Ustawienia Postaci",GUIEditor_TabPanel.main)
	local lineH = 0.0515
	local posY = lineH
	
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Ogólne ustawienia:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Blur",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_skyclouds = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Chmury",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.streams = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Dodatkowe kanały dźwięku",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_logs = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Logi czatu",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.cellphone_log = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Logi czatu oraz SMS",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_chatbub = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Dymki nad głowami",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_typingicon = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ikona wpisywania wiadomości",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat-system") then
	...
	GUIEditor_Checkbox.graphic_nametags = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Nazwy graczy nad głowami",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.settings_hud_style = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ładniejszy HUD",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	GUIEditor_Checkbox.graphic_shaderradar = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Shader Radaru",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderwater = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Shader Wody",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Shadery pojazdów",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh_reflect = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Odbijanie światła od pojazdów",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shader_darker_night = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ciemniejsza noc",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.autopark = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Automatyczne /zaparkuj",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.antifalling = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Anty spadanie wewnątrz pomieszczeń",false,true,GUIEditor_Tab.graphicSettings)
	...
	local posX = lineW2
	posY = 0.1005
	GUIEditor_Checkbox.vehicle_hotkey = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Klawisze sterowania pojazdami",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("vehicle-system") then
	...
	posY = posY + lineH
	GUIEditor_Checkbox.vehicle_rims = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Niestandardowe dodatki pojazdów",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.text2speech_ic_chats = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Tekst na Mowę",false,true,GUIEditor_Tab.graphicSettings)
	...
	posX = posX + lineW2
	GUIEditor_Label.graphicSettings_desc = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Ustawienia Opisów:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettings_desc,"default-bold-small")
	
	GUIEditor_Checkbox.enableOverlayDescription = guiCreateCheckBox(0.036+posX,0.1005,0.2992,lineH,"Ogólne opisy",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.enableOverlayDescriptionVeh = guiCreateCheckBox(0.036+posX,0.1005+lineH,0.2992,lineH,"Opisy Pojazdów",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	guiCreateLabel ( 0.036+posX,0.1005+lineH*2+0.005,0.2992,lineH ,  "Czcionka:", true, GUIEditor_Tab.graphicSettings )
	...
	GUIEditor_Checkbox.enableOverlayDescriptionPro = guiCreateCheckBox(0.036+posX,0.1005+lineH*3,0.2992,lineH,"Opisy pomieszczeń",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	guiCreateLabel ( 0.036+posX,0.1005+lineH*4+0.005,0.2992,lineH ,  "Czcionka:", true, GUIEditor_Tab.graphicSettings )
	...
	GUIEditor_Label.charSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Ustawienia Postaci:",true,GUIEditor_Tab.charSettings)
	guiSetFont(GUIEditor_Label.charSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.phone_anim = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Animacja telefonu",false,true,GUIEditor_Tab.charSettings)
	...
	GUIEditor_Checkbox.talk_anim = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Animacja podczas rozmowy",false,true,GUIEditor_Tab.charSettings)
	...
	GUIEditor_Button.mainclose = guiCreateButton(0.0135,0.9135,0.9743,0.0675,"Zamknij",true,GUIEditor_Window.main)
